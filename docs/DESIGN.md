# Tensor Workbench: design notes

Detailed notes behind the [README](../README.md): the demo walkthrough, architecture, data model, queue
semantics, failure handling, result delivery, API, measurements and production extensions.
